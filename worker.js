 ...
 * POST — stores in Supabase, emails via Resend
...
export default {
  async fetch(request, env) {
        ...
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
          ...
          <div style="padding:32px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px">
            ...
            <table style="width:100%;border-collapse:collapse">
              <tr><td style="padding:10px 12px;font-weight:700;background:#f9f9f9;width:120px;border-radius:4px">Name</td><td style="padding:10px 12px">${esc(name)}</td></tr>
              ...
              <tr><td style="padding:10px 12px;font-weight:700;background:#f9f9f9;width:120px;border-radius:4px">Plan</td><td style="padding:10px 12px">${esc(plan || 'Not sure yet')}</td></tr>
              <tr><td style="padding:10px 12px;font-weight:700;width:120px;vertical-align:top">Project</td><td style="padding:10px 12px">${esc(project || '—')}</td></tr>
            </table>
            <div style="margin-top:28px">
              <a href="https://supabase.com/dashboard/project/ouwyuxqlvjvxdobjnezu/editor" style="background:#7B2FFF;color:#fff;padding:12px 28px;border-radius:100px;text-decoration:none;font-weight:700;display:inline-block">
                View in Supabase →
              </a>
            </div>
          </div>
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
          ...
          <div style="padding:32px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px">
            ...
            ${project ? `
            <div style="background:#f8f8ff;border-left:3px solid #7B2FFF;padding:12px 16px;margin:24px 0;border-radius:0 8px 8px 0">
    ...
    // Return success even if emails had issues (lead is saved)
    // But include errors so we can debug
    return json({
      success: true,
